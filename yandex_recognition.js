...
const gameCommands = {
  ...
  "compare": ["запусти игру сравнение", "сравнение открой"],
  "differences": ["запусти игру отличия", "отличия открой"],
  "distribution": ["запусти игру распределение", "распределение открой"],
  "order": ["запусти игру очередность", "очередность открой"],
  "history": ["запусти игру история", "история открой"]
};
